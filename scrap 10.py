...
#import json to use json file for questions.json
import json
...
class Quiz:
    ...
    # sets the questions.json count to 0. and initialize all the
    # other methoods to display the content and make all the
    # functionalities available
    def __init__(self):

        # set questions.json number to 0
        self.q_no=0
        ...
        # selected option in a questions.json.
        self.opt_selected=IntVar()

        # displaying radio button for the current questions.json and used to
        # display options for the current questions.json
    ...
    # current questions.json by calling the check_ans and questions.json no.
    # if the questions.json is correct it increases the count by 1
    # and then increase the questions.json number by 1. If it is last
    # questions.json then it calls display result to show the message box.
    # otherwise shows next questions.json.
    def next_btn(self):
        ...
        # checks if the q_no size is equal to the questions.json size
        if self.q_no==self.data_size:
            ...
            # shows the next questions.json
            self.display_question()
            self.display_options()


    # This method shows the two buttons on the screen.
    # The first one is the next_button which moves to next questions.json
    ...
    # questions.json which we obtain through the questions.json number and Updates
    # each of the options for the current questions.json of the radio button.
